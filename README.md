...
6. If you plan on running the tests for the server, follow the instructions below in the section titled "Special note on tests" before proceeding to step 7. If instead you are trying to connect this service to a proxy, proceed to step 8. Step 9 and further is if you want to run tests on the service components.
